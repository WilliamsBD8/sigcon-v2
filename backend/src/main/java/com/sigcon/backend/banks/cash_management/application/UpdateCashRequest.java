...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Datos requeridos para editar/actualizar una caja")
public class UpdateCashRequest {
    ...
    @Schema(description = "Motivo del cambio (requerido para cambios sensibles en cajas con movimientos)", example = "Actualización de responsable por cambio organizacional")
    @Size(min = 10, message = "El motivo del cambio debe tener mínimo 10 caracteres")
