...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Respuesta con los datos de un encabezado de factura")
public class Header {

    @Schema (description = "ID único interno de la factura", example = "1")
    private Long id;
    ...
    @Schema (description = "Estado interno de la factura", example = "PENDING - PAID")
